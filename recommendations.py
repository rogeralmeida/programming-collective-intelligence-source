...
def sim_distance(prefs,person1,person2):
	...
	sum_of_square=sum([pow(prefs[person1][item]-prefs[person2][item],2) for item in prefs[person1] if item in prefs[person2]])

	return 1/(1+sum_of_square)

#Returns the Pearson correlation coefficient fo p1 and p2
