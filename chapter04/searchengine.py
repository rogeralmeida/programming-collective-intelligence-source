...
class searcher:
	...
	def getmatchrows(self,q):
		...
		#WTF he is doing something like this: 
		#select w0.location, w1.location... wn.location 
		#from wordlocation w0, wordlocation w1... wordlocation wn 
		#where w0.wordid=# and w1.wordid=## and ... wn.wordid = n.#
		return rows,wordids
